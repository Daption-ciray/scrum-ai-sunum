  ...
  return (
    <main className={g.sayfa}>
      <div className={g.kutu}>
        <p className={`etiket ${g.ust}`}>Scrum + AI · İç Eğitim</p>
        <h1 className={g.baslik}>Adınızı yazın, oturuma katılın</h1>
        <p className={g.aciklama}>
          Slaytlar bu ekranda akacak. Quiz de aynı yerden — başka bir uygulama açmanız
          gerekmiyor.
        </p>
        ...
        <p className={g.dipnot}>
          Bu ad quiz liderlik tablosunda görünecek. Takma ad da olur.
        </p>
      </div>
    </main>
  );

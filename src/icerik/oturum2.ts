...
export const oturum2: Oturum = {
  ...
  slaytlar: [
    ...
    {
      id: "s2-maskeleme-akis",
      blok: "Sorumlu kullanım: güvenlik ve etik",
      tip: "maskeakis",
      baslik: "Maskeleme neye benziyor",
      giris: "Bir önceki slayt teknikleri sayıyor. Şimdi uygulandığı ana bakalım: aynı istem, aynı iş, sadece hassas alanlar değişiyor.",
      katmanlar: ["Yazdığınız istem", "Maskeleme katmanı", "Modele giden"],
      parcalar: [
        { metin: "Müşteri " },
        { metin: "Ahmet Yılmaz", maske: "[MÜŞTERİ_7]" },
        { metin: " (TCKN " },
        { metin: "12345678901", maske: "[KİMLİK]" },
        { metin: ", " },
        { metin: "0532 114 22 87", maske: "[TELEFON]" },
        { metin: ") ödeme ekranında \"kart doğrulanamadı\" hatası alıyor. Bu şikâyeti kabul kriterine çevir." },
      ],
      sonuc: "Modele bu hâli gidiyor. İş aynı iş: kabul kriteri yazmak için gerçek ad, kimlik ve numara gerekmiyor — yalnızca biçimleri gerekiyor.",
      kaynak: "Maskeleme kurumsal araçlarda hazır gelebilir; gelmiyorsa yapıştırmadan önce elle yapılır.",
      not: "Çizginin geçişini bekle, konuşma. Ekranda ad bloğa dönüşünce sor: bu istemin işi değişti mi? Değişmedi — asıl mesaj bu. Ardından ekle: maskeleme kuralı hatırlamakla değil, alışkanlıkla tutar; bu yüzden bir sonraki blokta ekip anlaşmasına yazacağız.",
    },
    ...
    {
      id: "b-anlasma",
      blok: "Ekibin AI kuralları",
      tip: "bolum",
      numara: "12",
      baslik: "Ekibin AI kuralları",
      ozet: "Beş satır. Ekibin panosunda asılı duracak, herkesin okuyabileceği kadar kısa.",
      not: "Ayraç. Beş saniye dur, blok adını söyle, geç. Duyuruda \"ortak bir yaklaşım oluşturmak\" yazıyordu — bu blok o sözün karşılığı. Scrum dilinde adı \"çalışma anlaşması\"; bir kez söyle, sonra \"kurallar\" demeye devam et.",
    },
    {
      id: "s2-anlasma",
      blok: "Ekibin AI kuralları",
      tip: "kartlar",
      baslik: "Ekibin cevaplaması gereken beş soru",
      giris: "Eğitimden çıkan tek somut şey bu: beş soru, beş cümle. Cevapları ekip kendi yazar — aşağıdakiler örnek, kural değil.",
      kartlar: [
        {
          ust: "NEREDE",
          ana: "Hangi toplantıda kullanıyoruz, hangisinde kullanmıyoruz?",
        ...
        },
        {
          ...
          ana: "Bu kurallara ne zaman tekrar bakıyoruz?",
    ...
    },
    {
      ...
      blok: "Ekibin AI kuralları",
      tip: "madde",
      baslik: "Yazılmış hâli neye benziyor",
      giris: "Beş soruyu cevaplayan bir ekip şunu yazdı. Sizinki farklı olacak — önemli olan bu kadar kısa ve bu kadar net olması.",
      maddeler: [
        {
          ana: "Daily Scrum'da kullanmıyoruz. Planning ve Refinement öncesinde kullanıyoruz.",
          alt: "Toplantının içinde değil, hazırlığında.",
        },
        {
          ana: "Müşteri adı, kişisel veri ve sözleşme metni araca girmiyor.",
          alt: "Gerekiyorsa maskeliyoruz. Emin değilsek yapıştırmadan önce soruyoruz.",
        },
        {
          ana: "AI'dan çıkan hiçbir şey okunmadan işe girmiyor.",
          alt: "Gözden geçiren kişi adını yazıyor. \"AI öyle demişti\" bir gerekçe değil.",
        },
        {
          ana: "AI ile üretilen taslağın altına tek satır not düşüyoruz.",
          alt: "\"Taslak AI ile üretildi · gözden geçiren: ...\" Kim yazdı sorusu cevapsız kalmıyor.",
        },
        {
          ana: "Her Retrospektif'te bu beş satıra bakıyoruz.",
          alt: "İşe yaramayanı siliyoruz, eksik olanı ekliyoruz. Liste büyümüyor, değişiyor.",
        },
      ],
      not: "SLAYDIN İŞİ SOMUTLAŞTIRMAK. Beş başlık slaydı soyut kalıyordu — katılımcı yazacağı şeyin neye benzediğini görmeden \"yazın\" demek işe yaramıyor. Bunu yavaş oku, sonra söyle: sizinki bundan farklı olacak, ama bu uzunlukta olacak. Panoya asılamayacak kadar uzunsa kimse okumaz.",
    },

    {
      ...
      blok: "Ekibin AI kuralları",
      tip: "madde",
      baslik: "Bunu ne zaman yazacaksınız",
      giris: "Bu eğitimden sonra ekibinizle on beş dakika. Daha uzunu gerekmiyor.",
      maddeler: [
        { ana: "Beş soruyu sırayla sorun", alt: "Her soruya tek cümle. Uzun metin okunmuyor, okunmayan kural uygulanmıyor." },
...

    {
      ...
      numara: "13",
      baslik: "Eylem planı",
      ozet: "Herkes tek bir adım seçer, iki Sprint sonra ölçeriz.",
      not: "Ayraç. Beş saniye dur, blok adını söyle, geç. Katılımcı nerede olduğunu bilsin diye var.",
    },
    {
      id: "s2-eylem-plani",
      ...
      giris: "Herkes tek bir adım seçer. Üç alanı doldurun, sohbete yazın.",
      maddeler: [
        { ana: "Hangi etkinlikte başlayacağım", alt: "Tek bir etkinlik seçin. Hepsini birden değiştirmek işe yaramıyor; biri oturunca sonrakine geçilir." },
    ...
    },
    {
      ...
      blok: "Eylem planı",
      tip: "vurgu",
      metin: "Herkes tek bir adım seçsin. İki Sprint sonra ölçelim.",

...
export const oturum1: Oturum = {
  ...
  slaytlar: [
    ...
    },
    {
      ...
      blok: "Etkili istem yazımı",
      tip: "madde",
      baslik: "Peki siz ne yapacaksınız",
      giris: "Yedi parçanın çoğunu araç yönetiyor. Sizin elinizde dört karar var ve dördü de aynı şeyle ilgili: modelin bilmediğini vermek.",
      maddeler: [
      ...
      not: "Bir önceki slayt kavramı verdi, bu slayt uygulamayı. Bir cümlede özetle: çöp girerse çöp çıkar. Katılımcıların çoğu tek satırlık istem yazıyor — asıl atlanan şey bağlam. Dördüncü maddede dur: kurumsal dokümanla çalışacaksanız modele belgeyi GETİRTİN, ezberinden yanıtlamasını istemeyin. Bu, önceki slayttaki RAG kartının pratik karşılığı.",
    },
    {
      id: "s1-prompt-kalibi",
      blok: "Etkili istem yazımı",
...
Varsayım yaptığın yeri [VARSAYIM] diye işaretle.`,
    ...
    },
    {
      ...
      giris:
        "İkisi de aynı iş öğesi için yazıldı. Şimdi ikisini de aynı araca vereceğiz ve dönen çıktıları yan yana koyacağız. Fark modelde değil, istemde.",
